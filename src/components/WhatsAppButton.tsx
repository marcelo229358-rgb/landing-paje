...
const mensagem = 'Olá! Gostaria de saber mais sobre as soluções digitais da Deploy.';

export default function WhatsAppButton() {
  const url = `https://wa.me/${mockSiteConfig.whatsapp}?text=${encodeURIComponent(mensagem)}`;
